import { GeneratedAt } from '~/domain/webdb-sample/components/atoms/GeneratedAt'
import { Loading } from '~/domain/webdb-sample/components/atoms/Loading'
import { Template } from '~/domain/webdb-sample/components/templates/users/[username]/[repo]'
import Error from '~/pages/github/_error'
import { now } from '~/domain/webdb-sample/utils/date'
